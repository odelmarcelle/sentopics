...
test_that("rJST works", {
  expect_silent(rJST <- grow(rJST(toks, lexicon = LoughranMcDonald), 10, displayProgress = FALSE))
...
test_that("JST works", {
  expect_silent(JST <- grow(JST(toks, lexicon = LoughranMcDonald), 10, displayProgress = FALSE))
...
test_that("sentopicmodel works", {
  expect_silent(sentopicmodel <- grow(sentopicmodel(toks, lexicon = LoughranMcDonald), 10, displayProgress = FALSE))
