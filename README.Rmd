...
Using a sample of press conferences from the European Central Bank, a LDA model is easily created from a list of tokenized texts. See https://quanteda.io for details on `tokens` input objects and pre-processing functions.
